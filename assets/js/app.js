...
function promedio() {
  if (
    ...
    if (resultado >= 6) {
      ...
      mensaje.textContent = `Tienes promedio: ${resultado.toFixed(1)}. ¡Sigue adelante, puedes mejorar!`;
      app.append(mensaje);
      console.log(mensaje.textContent)
      alert(mensaje.textContent)
      return;
      ...
      mensaje.textContent = `Has reprobado con promedio: ${resultado.toFixed(1)}`;
      app.append(mensaje);
      console.log(mensaje.textContent)
      alert(mensaje.textContent)
      return;
